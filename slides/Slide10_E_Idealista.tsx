...
const LeadDetailCard = () => (
    <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-8 h-full flex flex-col">
        <div className="flex justify-between items-center mb-6">
            <h3 className="text-2xl font-bold text-slate-800">Nueva Oportunidad Detectada</h3>
        ...
        <SlideWrapper className="p-16 flex flex-col justify-center">
            ...
            >
              <motion.div variants={itemVariants}>
                <h2 className="text-7xl font-bold tracking-tighter text-slate-900 text-center mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Caso de Uso: Prospección Real Estate</h2>
                <p className="text-3xl text-slate-600 mb-10 text-center">Identificando oportunidades de alto valor en el mercado inmobiliario.</p>
              </motion.div>
              <motion.div 
