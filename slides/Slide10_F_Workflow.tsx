...
export const Slide10_F_Workflow: React.FC<{isActive: boolean}> = ({ isActive }) => {
    return (
        <SlideWrapper className="p-16">
            ...
            >
                <motion.h2 variants={itemVariants} className="text-7xl font-bold tracking-tighter text-slate-900 text-center mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>De Señal a Estrategia</motion.h2>
                <motion.p variants={itemVariants} className="text-3xl text-slate-600 mb-12 text-center">El ciclo de vida del caso proactivo.</motion.p>
                ...
                >
                    ...
                    <div className="col-span-3">
                        <Card>
                            ...
                            <div className="bg-slate-50/70 p-5 rounded-lg border border-slate-200 flex-grow">
                                <p className="font-semibold text-slate-500 text-xl">Nueva Señal de Mercado</p>
                                <p className="font-bold text-slate-800 text-3xl mt-3">Transacción Inmobiliaria</p>
                                <p className="text-slate-600 text-2xl">Valor: <span className="font-semibold">€2.5M</span></p>
                                <p className="text-slate-600 text-2xl">Zona: <span className="font-semibold">Recoletos, Madrid</span></p>
                                <p className="text-slate-400 text-base mt-3">Fuente: Reg. de la Propiedad</p>
                            </div>
                        </Card>
                    </div>
                        ...
                        <Card className="bg-cyan-500/5">
                            <h3 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-4"><BarChart size={32} className="text-cyan-500"/> 2. Vista 360°</h3>
                             <div className="bg-white p-5 rounded-lg border border-slate-200 space-y-4">
                                <div>
                                    <h4 className="font-bold text-slate-900 text-3xl">Global Realty S.L.</h4>
                                    <p className="text-slate-500 text-xl">Caso Proactivo #1138</p>
                                </div>
                                <div className="space-y-3">
                                    <p className="text-2xl flex items-center gap-3"><User size={20}/> <strong>Contacto IA:</strong> A. García (CEO)</p>
                                    <p className="text-2xl flex items-center gap-3"><FileText size={20}/> <strong>Documento:</strong> Nota Simple</p>
                                </div>
                                <div className="bg-slate-100/60 p-4 rounded-md">
                                    <p className="font-semibold text-cyan-800 text-xl">Insight Estratégico IA:</p>
                                    <p className="text-slate-700 text-xl leading-relaxed">Empresa muestra expansión recurrente. Copilot recomienda consultoría urbanística.</p>
                                </div>
                            </div>
                        </Card>
                    </div>
                    ...
                    <div className="col-span-3">
                        <Card>
                            ...
                            <div className="bg-slate-50/70 p-5 rounded-lg border border-slate-200 flex-grow">
                                 <p className="font-semibold text-slate-500 text-xl">Copilot de Contacto</p>
                                <p className="text-slate-700 bg-white p-4 rounded-md mt-3 text-xl border">
                                    "Estimada Sra. García,
